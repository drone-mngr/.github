...
This public repository is the canonical source for GitHub-supported fallback community files, organization profile content, reusable workflow examples, and public contributor guidance for [`drone-mngr`](https://github.com/drone-mngr).

- GitHub owner: [`drone-mngr`](https://github.com/drone-mngr)
- Linear project: [github.com/drone-mngr](https://linear.app/denman/project/githubcomdrone-mngr-8ac391ac308d)
