# drone-mngr organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`drone-mngr`](https://github.com/drone-mngr).

## Canonical organization links

- GitHub organization: https://github.com/drone-mngr
- Public organization defaults: https://github.com/drone-mngr/.github
...
`drone-mngr` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
