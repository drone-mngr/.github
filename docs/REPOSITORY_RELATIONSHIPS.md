...
# Repository relationships for `drone-mngr`
...
- Inventory digest: `sha256:97078d17704277026ac421aab572b7c1fcba43a1390150496ecacaeedb41e858`

## Immutable routing identity

| Field | Value |
|---|---|
| Mapping ID | `context:drone-mngr` |
| GitHub owner ID | `308176360` |
| Linear project ID | `89e8fc0d-283c-485a-94ac-a3d31917a64b` |
...
|---|---|---|---|
| `drone-mngr/.github` | `public` | `community-health`, `governance`, `relationship-registry` | no |
