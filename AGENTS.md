...
3. Review linked pull requests, issues, Linear work, related repositories in `drone-mngr`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
...
- During integration, avoid git rebase in favor of git merge so reviewable branch ancestry is preserved.
